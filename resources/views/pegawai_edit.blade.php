    ...
    function dis_kategori(cek){
        ...
        <div class="container">
            <div class="card mt-5">
                ...
                <div class="card-body">
                    <a href="/list_item" class="btn btn-primary">Kembali</a>
                    <br/>
                    <br/>
                    

                    <form method="post" action="/update/{{ $pegawai->gid }}" enctype="multipart/form-data">
            ...
            <div class="row">  
                ...
                <input type="hidden" name="gid" value="{{$pegawai->gid}}">
                <label>Nama</label>
                ...
                <label>Aktifkan</label><br>
                    <input type="checkbox" value="1" name="is_aktif" @if($pegawai->is_aktif == '1') checked @endif > Ya
                </div>
                ...
                <label>Kategori</label><br>
                    <select name="kategori" id="kategori" class="custom-select" autocomplete="off" style="width:50%">
                        ...
                        $select = '';
                        if($pegawai->kategori == ''){
                            if($pegawai->sub_kategori == $kat->kategori){
                                $select = 'selected';
                            }
                        }
                        @endphp
                ...
                <label>Harga</label><br>
                    <input type="number" name="harga" class="form-control col-md-9" value="{{ $pegawai->harga }}">
                </div>

                <div class="col-md-12 form-group">
                <label>Deskripsi</label>
                 <!-- style="height: 201px; width:536px;" -->
                    <textarea name="deskripsi" id="mytextarea" class="form-control" rows="3" placeholder="Uraian Deskripsi ...">{{ $pegawai->deskripsi }}</textarea>
                </div>
                ...
                <div class="col-md-3 form-group">
                    ...
                    <div class="card mb-2" style="max-width: 200px;">
                        <img class="img-fluid mb-2" src="{{ url('/images').'/'.$pegawai->lokasi }}">
                    </div>
                ...
                <div class="col-md-3 form-group">
                    ...
                    <div class="card mb-2" style="max-width: 200px;">
                        <img class="img-fluid mb-2" src="{{ url('/images').'/'.$pegawai->lokasi2 }}">
                    </div>
                ...
                <div class="col-md-3 form-group">
                    ...
                    <div class="card mb-2" style="max-width: 200px;">
                        <img class="img-fluid mb-2" src="{{ url('/images').'/'.$pegawai->lokasi3 }}">
                    </div>
                ...
                <div class="col-md-3 form-group">
                    ...
                    <div class="card mb-2" style="max-width: 200px;">
                        <img class="img-fluid mb-2" src="{{ url('/images').'/'.$pegawai->lokasi4 }}">
                    </div>
