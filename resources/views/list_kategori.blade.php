    ...
    <body>
        <div class="container">
            ...
            <div class="card mt-5">
                ...
                <div class="card-body">
                    <a href="/kat/tambah" class="btn btn-primary">Input Kategori Baru</a>
                    <br/>
                    <br/>
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr style="background-color: {{$bg}} ;">
                                ...
                                <td>{{ $status }}</td>
                                <td>
                                    <a href="/kat/edit/{{ $p->gid }}" class="btn btn-warning">Edit</a>
                                    <a href="/kat/hapus/{{ $p->gid }}" class="btn btn-danger">Hapus</a>
                                </td>
                            </tr>
                            @php $no++; @endphp
                            @endforeach
